...
from .mmarco import MmarcoReader
...
class SPLADE(BaseModel):
    ...
    def __init__(
        ...
        device: str = None,
        extra_files_to_load = ["config_sparse_retrievers.json"],
    ) -> None:
        super().__init__(
    ...
    def fit(
        ...
        mmarco_data_config = None,
        rank_loss_config = None,
        reg_loss_config = {'query_reg': 'FlopsLoss', 'query_reg_weight': 3e-4, 'doc_reg': 'FlopsLoss', 'doc_reg_weight': 1e-4},
        steps: int = 150000,
        batch_size: int = 128,
